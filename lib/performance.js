((root, factory) => {
  ...
  function normalizeProfile(value) { return Object.hasOwn(profiles, value) ? value : 'balanced'; }
  function timingsFor(value) {
    return { ...profiles[normalizeProfile(value)], suggestionTimeoutMs: 18000, selectionTimeoutMs: 8500, persistentErrorMs: 3200 };
  }
  ...
  return { normalizeProfile, timingsFor, profileHint };
});
